...
use backend\models\MenuFood;
use backend\utilities\table\DataTable;

class MenuFoodTable extends DataTable
{
	...
	public function getData()
	{
		...
		foreach ($models as $model) {
			...
			$tempArray[] = $model->menu_group_id;
			$tempArray[] = $model->food_id;
	...
	public function getModels()
	{
		...
		$models = MenuFood::find()->where(['is_delete' => 0]);
