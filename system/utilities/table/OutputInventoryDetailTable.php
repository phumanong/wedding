...
use backend\models\OutputInventoryDetail;
use backend\utilities\table\DataTable;

class OutputInventoryDetailTable extends DataTable
{
	...
	public function getData()
	{
		...
		foreach ($models as $model) {
			...
			$tempArray[] = $model->output_inventory_id;
	...
	public function getModels()
	{
		...
		$models = OutputInventoryDetail::find()->where(['is_delete' => 0]);
